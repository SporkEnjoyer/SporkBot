	...
	execute:(message, args, client) => {
		function getRandomInt(max) {
		  ...
		  if (megaspork === 1) {
			  ...
			  client.user.setActivity('fuck you all, spork fbghuoasdgbfoguoiduhuioafdshuiofadshiouafdsihuofadsihuogdfasihuogfdshioufdgshuiogfdshuiogfdshuiofgdsbjhkgfsdbjkhfgdsbkjhgfdsjkbhfgdsbiukhjgfdshuiogfdshuiogfdshuiosgfdhuiogshbjsgfhbjkgsdfkhjbsgdfbhjksgdfhuiogrseiuhogsdrjhbsdfgrhbjk', { type: 'PLAYING' });
